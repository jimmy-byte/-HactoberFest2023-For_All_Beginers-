##This will really help out a lot while calculationg inverse of any nonSingular Square Matrix
...
while(True):
    ...
    finding_inverse()
    print()
    print("We saved your time so that you can think about the fact that the ")
    print("elements present in your body came from a star which exploded")
    print("millions and millions light years back in time!!")
